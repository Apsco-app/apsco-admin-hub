        ...
        <div className="p-6 bg-white shadow rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 text-gray-700">
                ...
                <div className="col-span-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${data.status === 'accepted' ? 'bg-green-100 text-green-800' :
            ...
            <div className="mt-8 pt-4 border-t">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded text-white font-medium transition duration-150 ${newStatus === data.status || isUpdating ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                            }`}
                    >
